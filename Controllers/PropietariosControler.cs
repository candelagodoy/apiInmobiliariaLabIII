    ...
    public class PropietariosController : ControllerBase
    {
        ...
        public async Task<IActionResult> Actualizar([FromForm] Propietario propietario)
        {
            ...
            try
            {
                ...
                var propietarioO = await context.Propietario.FirstOrDefaultAsync(x => x.email == propietario.email);
                ...
                {
                    propietario.clave = propietarioO.clave;
                }
                else
                {
                ...
                propietario.idPropietario = propietarioO.idPropietario;
                context.Entry(propietarioO).CurrentValues.SetValues(propietario);
